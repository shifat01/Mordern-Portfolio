...
function ExperienceItem({exp, idx, start, end, scrollYProgress, layout}){
  ...
  if(layout === "desktop"){
    return(
      <div className="relative -top-4 flex flex-1 justify-center items-center min-w-0">
        {/* white circle */}
...
export default function Experience(){
  ...
  const lineSize = useTransform(scrollYProgress, (v) => isMobile? `${v*90}%`: `${v*100}%`);
    ...
    <section  id="experience" className="relative bg-black text-white">
      ...
      >
        <div className="sticky top-0 h-screen flex flex-col">
          <h2 className="text-4xl sm:text-5xl font-semibold mt-13 text-center">
            Experience
          </h2>
          <div className="flex flex-1 items-center justify-center px-6 pb-10">
            ...
            {isMobile && (
              <div className="relative w-full max-w-md">
                {/* virticle white line */}
                <div className="absolute left-0 top-0 bottom-0 h-150 w-1.5 bg-white/15 rounded">
