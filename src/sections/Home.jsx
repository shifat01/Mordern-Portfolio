        ...
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          <div className="w-full lg:pr-24 mx-auto max-w[48rem] lg:ml-30">
            ...
            >
              ...
              <motion.h1
                className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-transparent bg-clip-text bg-linear-to-r from-[#1cd8d2] via-[#00bfaf] to-[#302ba3] drop-shadow-lg"
                initial={{opacity: 0}}
                animate={{opacity: 1, y: 0}}
              ...
              <motion.p className="mt-4 text-base sm:text-xl text-gray-300 max-w-2xl mx-auto lg:mx-0"
                initial={{opecity:0, y: 20}}
                animate={{opecity:1, y: 0}}
                transition={{delay: 0.4, duration: 0.8}}
              >
                I turn complex ideas into seamless, high-impact web experiences - building mordern, scalable and lightning-fast applications that make a difference. 
              </motion.p>
              <motion.div
