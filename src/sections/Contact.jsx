            ...
            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col">
                ...
                >
                  ...
                  <option value="Custom Web Application" className="text-black">
                    Custom Web Application
                  </option>
                  <option value="Portfolio Website" className="text-black">
                    Portfolio Website
                  </option>
                  <option value="E-Commerce Store" className="text-black">
                    E-Commerce Store
                  </option>
                  <option value="Fix Existing Website" className="text-black">
